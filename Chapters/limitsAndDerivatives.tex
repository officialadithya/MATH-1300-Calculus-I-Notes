    ...
    \subsection{Limits Involving Infinity}
        ...
        \begin{example}{\Difficulty\,\Difficulty\,\,Determining Infinite Limits Graphically}{detinflimgraph}
            ...
            \begin{center}
                \begin{tikzpicture}[scale=1]
                    \begin{axis} [def]
                        \addplot [domain=-5:-1, restrict y to domain=-5:5] {1/(x+2)};
                        \addplot [domain=-2:-2, dashed] coordinates {(-2,-5)(-2,5)};
                        \addplot [domain=-1:2, restrict y to domain=-5:5] {1/x^2};
                        \addplot [domain=2:5, restrict y to domain=-5:5] {-1/(x-4)^2};
                        \addplot [domain=-2:-2, dashed] coordinates {(4,-5)(4,5)};
                        \addplot [only marks, mark=o] table {
                        -1 1
                        2 0.25
                        2 -0.25
        ...
        \\
        \\
        We will now turn our attention to limits at infinity. Consider the following definition.
        ...
        \end{definition}
        \begin{example}{\Difficulty\,\Difficulty\,\,Determining Limits at Infinity Graphically}{detliminfgraph}
            Let \(f(x)\) be defined by the following graph.
            \begin{center}
                \begin{tikzpicture}[scale=1]
                    \begin{axis} [def]
                        \addplot [domain=-10:10, restrict y to domain=-10:10] {(3*x-2)/(sqrt(4*x^2+5))};
                        \addplot [domain=-10:10, dashed] coordinates {(-10,-3/2)(10,-3/2)};
                        \addplot [domain=-10:10, dashed] coordinates {(-10,3/2)(10,3/2)};
                        \addplot[mark=*] coordinates {(0,3/2)} node[pin=150:{\((0,\frac{3}{2})\)}]{};
                        \addplot[mark=*] coordinates {(0,-3/2)} node[pin=330:{\((0,-\frac{3}{2})\)}]{};
                    \end{axis}
                \end{tikzpicture}
            \end{center}
            \vphantom
        ...
        \begin{theorem}{\Stop\,\,Limit at Infinity of a Reciprocal Function}{liminfrecipro}
